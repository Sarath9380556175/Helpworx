...
this.setState({[name]:value})
   ...
   this.setState({[name]:value})
    ...
    <div className="text-primary mt-1 mr-2" style={{border:'4px double red',padding:'4px 4px 4px 4px',display:'inline-block',float:'right'}} onClick={()=>this.handleaccount('iscreatingaccount',true)}>signup</div>
</div>
...
<div className="text-center">
    ...
    <div onClick={()=>this.handleaccount('iscreatingaccount',false)} style={{float:'right',marginTop:'-49px',fontSize:'20px',fontStyle:'italic',color:'gold',marginRight:'-16px'}}>close</div>
       ...
       <i className="fas fa-user"></i>&nbsp;&nbsp;<input type="text" name="name"  required  onChange={this.handlename} placeholder="Name of the employee" /><br/><br/>
